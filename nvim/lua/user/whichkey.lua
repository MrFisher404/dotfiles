...
local mappings = {
  ...
  s = {
    ...
    f = {"<cmd>Telescope file_browser path=%:p:h<cr>", "File"}
  },
...
local mappings_visual = {
  n = {
    ...
    t = {
      name = "Title",
      n = { "<cmd>'<,'>ZkNewFromTitleSelection { dir = note, date = 'today'}<CR>", "Note" },
      f = { "<cmd>'<,'>ZkNewFromTitleSelection { dir = 'Quick', date = 'today'}<cr>", "Quick" },
    },
    c = {
      name = "Content",
      n = { "'<,'>ZkNewFromContentSelection { dir = note, date = 'today', title = vim.fn.input('Title: ') }<CR>", "Note" },
      f = { "'<,'>ZkNewFromContentSelection { dir = 'Quick', date = 'today', title = vim.fn.input('Title: ')}<cr>", "Quick" },
    }
  },
